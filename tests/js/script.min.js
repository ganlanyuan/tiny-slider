...
var tns = function(options) {
  options = extend({
    container: doc$1.querySelector('.slider'),
    mode: 'carousel',
    axis: 'horizontal',
    items: 1,
    gutter: 0,
  ...
  ['container', 'controlsContainer', 'navContainer', 'autoplayButton'].forEach(function(item) {
    if (typeof options[item] === 'string') { options[item] = doc$1.querySelector(options[item]); }
  });
  ...
  var horizontal = options.axis === 'horizontal' ? true : false,
      outerWrapper = doc$1.createElement('div'),
      innerWrapper = doc$1.createElement('div'),
  ...
  (function sliderInit() {
    ...
    // clone slides
    if (loop || edgePadding) {
      var fragmentBefore = doc$1.createDocumentFragment(), 
          fragmentAfter = doc$1.createDocumentFragment();
    ...
    if (arrowKeys) { addEvents(doc$1, docmentKeydownEvent); }
...
// === ON RESIZE ===
  ...
  function resizeTasks() {
    ...
    if (breakpointZoneTem !== breakpointZone) {
      ...
      if (arrowKeys !== arrowKeysTem) {
        arrowKeys ?
          addEvents(doc$1, docmentKeydownEvent) :
          removeEvents(doc$1, docmentKeydownEvent);
      }
      ...
      if (hasAutoplay) {
        ...
        if (autoplayResetOnVisibility !== autoplayResetOnVisibilityTem) {
          autoplayResetOnVisibility ?
            addEvents(doc$1, visibilityEvent) :
            removeEvents(doc$1, visibilityEvent);
        }
  ...
  function onVisibilityChange() {
    if (autoplayResetVisibilityState != doc$1.hidden && animating !== false) {
      doc$1.hidden ? pauseActionTimer() : resetActionTimer();
    }
    autoplayResetVisibilityState = doc$1.hidden;
  }
  ...
  function onControlKeydown(e) {
    e = e || win.event;
    var code = e.keyCode,
        curElement = doc$1.activeElement;
  ...
  function onNavKeydown(e) {
    var curElement = doc$1.activeElement;
  ...
  return {
    ...
    destroy: function () {
      ...
      if (autoplay) {
        ...
        removeEvents(doc$1, {'visibilitychange': onVisibilityChange});
      }
      ...
      if (arrowKeys) {
        removeEvents(doc$1, {'keydown': onDocumentKeydown});
      }
