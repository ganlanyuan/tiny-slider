...
var doc = document;
var isDemoPage = doc.body.getAttribute('data-page') === 'demos';
var classIn = (doc.body.getAttribute('data-page') === 'demos') ? 'jello' : 'tns-fadeIn';
var classOut = (doc.body.getAttribute('data-page') === 'demos') ? 'rollOut' : 'tns-fadeOut';
var sliders = new Object();
var speed = Number(document.body.getAttribute('data-speed'));
var edgepadding = 50;
var gutter = 10;
var options= {
      'base': {
