...
- More options available for `responsive`. (from [v2.1.0](https://github.com/ganlanyuan/tiny-slider/releases/tag/v2.1.0), #53 [issue 53](https://github.com/ganlanyuan/tiny-slider/issues/53))
